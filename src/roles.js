export const roles = [
  ...
  },
  {
    ...
    description: "Promote handloom products, create marketing campaigns, and analyze sales data.",
    permissions: ["createCampaigns", "promoteProducts", "analyzeSales"],
    dashboard: "MarketingSpecialist"
  }
];
