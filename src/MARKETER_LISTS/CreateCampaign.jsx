...
import { Container, Typography, TextField, Button, FormControlLabel, Checkbox, Paper, Box } from '@mui/material';
...
function CreateCampaign() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', p: 3 ,bgcolor: 'linear-gradient(135deg, #282920ff 60%, #ceab83ff 100%)'}}>
      <Container component={Paper} sx={{ p: 3 }}>
        <Typography variant="h4" gutterBottom sx={{ color: '#222' }}>Create New Campaign</Typography>
        <form onSubmit={handleSubmit}>
          ...
          <Button type="submit" variant="contained" sx={{ mt: 3, bgcolor: '#6e4b1f', '&:hover': { bgcolor: '#bfa14a' } }} fullWidth>
